            ...
            <div className='bg-[#212120] relative h-screen max-h-screen overflow-hidden ' >
                ...
                <div className="h-full w-full p-2 relative py-4" >
                    <div className='h-full' >
                        <TopBar name={name} roomId={roomId} setShowRedirectHomeMessage={setShowRedirectHomeMessage} handleClearInterval={handleClearInterval} handleMove={handleMove} sideShowRequest={sideShowRequest} setShowRedirectHome={setShowRedirectHome} getMembers={getMembers}  socket={socket} numRequestWaiting={numRequestWaiting} hasGameStarted={hasGameStarted} isPlayerTurn={isPlayerTurn}  isRoomLead={isRoomLead} setShowOptionMenu={setShowOptionMenu} playerAway={playerAway} setPlayerAway={setPlayerAway} setPlayerLeft={setPlayerLeft} />
                        ...
                        <div className='relative flex md:absolute md:bottom-4 md:w-full' >
                            ...
                            <div className='absolute right-2 md:right-4' >
                                {isRoomLead && Object.keys(players).length > 1 && !hasGameStarted && <StartGameBtn roomId={roomId} setPlayerDate={setPlayerDate} getMembers={getMembers} setHasGameStarted={setHasGameStarted} setShowLoader={setShowLoader} setPlayerTimeout={setPlayerTimeout} setFullShow={setFullShow} socket={socket} roundDetails={roundDetails} getRoundDetails={getRoundDetails} />}
                            </div>
                        </div>
                    </div> 
